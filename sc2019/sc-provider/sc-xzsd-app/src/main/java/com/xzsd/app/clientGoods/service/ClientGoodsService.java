...
public class ClientGoodsService {
    ...
    public AppResponse getGoods(String goodsId) {
        ...
        //商品浏览量+1
        clientGoodsDao.countViewsNum(goodsId);
    ...
    public AppResponse listGoodsEvaluates(EvaluatesIn evaluatesIn){
        ...
        List<EvaluatesOut> list = clientGoodsDao.listGoodsEvaluatesByPage(evaluatesIn);
        // 包装Page对象
        PageInfo<EvaluatesOut> pageData = new PageInfo<EvaluatesOut>(list);
